...
export default function Contact() {
    ...
    return (
        <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-[url('/assets/footer-bg-color.png')] bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none">
            ...
            <h2 className="text-center text-5xl font-Ovo">Request an Estimate</h2>
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
                Ready to transform your space? Contact us today with details about your painting project, and we will get back to you to discuss timelines and pricing.
            </p>

            <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
                <input type="hidden" name="subject" value="Tru-colours Painting - New Quote Request" />
                ...
                <textarea rows="6" placeholder="Describe your painting needs (e.g., Interior, Exterior, Commercial)..." className="w-full px-4 py-2 focus:ring-1 outline-none border border-gray-300 dark:border-white/30 rounded-md bg-white mb-6 dark:bg-darkHover/30" required name="message"></textarea>
