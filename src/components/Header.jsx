export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">Tru-colours Painting.</h1>
            <p className="max-w-2xl mx-auto font-Ovo">Experienced Construction Painter with over 24 years of international <br />
                experience
in Portugal and Canada.</p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <a href="./assets/detail.resume" download
